...
const usePostPreviewOtherUrl = () => usePostComponent(state => state.otherUrl);
const usePostPreviewOpen = () => usePostComponent(state => state.open);
const usePostPreviewClose = () => usePostComponent(state => state.close);
const usePostPreviewUsername = () => usePostComponent(state => state.username);
const usePostPreviewUserProfile = () => usePostComponent(state => state.userProfile);
const usePostPreviewWatermarkEnabled = () => usePostComponent(state => state.watermarkEnabled);
