...
import { useOtherPrivatePostsStore } from "@/contexts/personal-private-context";
...
export default function PrivatePanelFetchOther(userid: number, pageNumber: number) {
    ...
    useEffect(() => {
        ...
        const api = `${process.env.NEXT_PUBLIC_TS_EXPRESS_URL}/post/private-posts/${userid}`
