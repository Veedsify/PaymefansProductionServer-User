...
const SideBar = React.memo(() => {
  ...
  return (
    <>
      <div
        className={`lg:ml-auto dark:bg-gray-950 bg-white h-screen lg:h-screen fixed lg:sticky top-0 z-[100] lg:z-[50] overflow-auto smart-width p-4 shadow-xl lg:shadow-none lg:border-r border-primary-dark-pink/40 transition-transform duration-300 ease-in-out dark:text-white dark:border-slate-800/100 ${
