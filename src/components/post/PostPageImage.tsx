...
const PostPageImage: React.FC<PostPageImageProps> = ({
    ...
    if (
        ...
        return (
            <div
                className="flex flex-col items-center justify-center object-cover w-full h-full gap-2 text-white bg-black shadow-md select-none aspect-square">
        ...
        <div className="relative">
            {media.media_type === "video" ? (
                <div className="relative">
                    ...
                    >
                        <button
                            className="flex items-center justify-center flex-shrink-0 w-12 h-12 p-1 rounded-full bg-primary-dark-pink aspect-square">
            ...
            {media.accessible_to === "price" && !canView && (
                ...
                >
                    ...
                    />
                    <div
                        className="lock-icon absolute inset-0 w-[85%] h-[65%] -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 rounded-lg flex items-center justify-center dark:bg-slate-900/70 bg-slate-900/40">
