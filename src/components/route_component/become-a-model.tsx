...
import { LucideChevronDown, LucideChevronUp, LucideEye, LucideLoader, LucideUser, LucideUser2 } from "lucide-react";
import Image from "next/image";
import Link from "next/link";
import { useRouter } from "next/navigation";
import { ChangeEvent, LegacyRef, MouseEvent, MutableRefObject, useEffect, useRef, useState } from 'react';
...
const BecomeAModel = () => {
    ...
    if (user?.is_model && user?.Model?.verification_status === true) {
        ...
        return <>
            <div>
                <div className="m-3 p-8 px-12 rounded-2xl dark:text-white">
                    <Image src="/icons/feeling_sorry.svg" width={300} height={300} alt="Sorry you are already a model" className="w-1/5 mx-auto block" />
                    <div className="flex flex-col justify-center align-center">
                        ...
                        <p className="text-center">
                            ...
                            Please go to your verification center to complete your verification
                        </p>
                        <div className="text-center">
                            <Link href="/verification" className="bg-primary-dark-pink inline-block text-white text-sm py-3 px-4 font-bold m-3 rounded-md text-center">
