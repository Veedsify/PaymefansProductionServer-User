...
const Header = () => {
    ...
    return (
        <header className="px-4 lg:px-8 py-3  bg-primary-dark-pink lg:bg-white dark:bg-gray-950 dark:text-white border-b dark:border-slate-800">
            <div className="flex items-center">
                ...
                <ul className="flex items-center gap-6 ml-auto lg:hidden">
                    <li className="relative">
                        ...
                        <ul
                            ref={ref}
                            className={`${notification ? "block" : "hidden"} absolute z-10 w-72 top-10 right-0 bg-white dark:bg-slate-900 dark:text-white rounded-lg max-h-[250px] overflow-y-auto shadow-2xl border`}>
                            <h1 className="text-black dark:text-white font-bold mb-3 p-4 pb-2">Notifications</h1>
                            <li>
