        ...
        return (
            <div className="bottom-0 lg:ml-4 lg:mr-2 relative max-h-max">
                {mediaFiles.length > 0 && !areAllUploadsComplete() && (
                    <div
                        className="mb-2 p-2 bg-blue-50 dark:bg-blue-900/30 rounded-lg border border-blue-200 dark:border-blue-700">
              ...
              <span className="text-blue-700 dark:text-blue-300">
                ...
                <div
                    className="flex flex-col w-full gap-2 border border-black/20 rounded-2xl px-2 dark:bg-gray-950 py-2 lg:rounded-xl">
