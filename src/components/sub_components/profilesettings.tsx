...
const ProfileSettings = ({user}: ProfileSettingsProps) => {
    ...
    const {message, canSave, error, isLoading} = useCheckUsername(user, usernameCheck);
        ...
        <div className="py-8 mx-auto bg-white dark:bg-gray-900 rounded-2xl">
            ...
            >
                ...
                <div>
                    ...
                    {isLoading && (
                        <div className={"py-2"}>
                            <LucideLoader2 size={10} className={"animate-spin text-primary-dark-pink"}/>
                        </div>
                    )}
                    {error && (
                ...
                <div className="space-y-3">
                    {/* Instagram */}
                    <div
                        className="grid grid-cols-12 items-center rounded-lg border border-black/10 dark:border-slate-700 bg-gray-50 dark:bg-slate-800 overflow-hidden transition-shadow focus-within:shadow-md group">
                        <div
                            className="flex items-center justify-center h-full col-span-2 bg-primary-dark-pink/10 dark:bg-primary-dark-pink/20 py-3 transition group-focus-within:bg-primary-dark-pink/20">
                    ...
                    <div
                        ...
                        <div
                            className="flex items-center justify-center h-full col-span-2 bg-primary-dark-pink/10 dark:bg-primary-dark-pink/20 py-3 transition group-focus-within:bg-primary-dark-pink/20">
                            <PiSnapchatLogoDuotone className="text-primary-dark-pink dark:text-white w-6 h-6"
                                                   size={20}/>
                        </div>
                        <input
                            type="text"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <svg width="24" height="24" fill="currentColor"
                                 className="text-primary-dark-pink dark:text-white w-6 h-6" viewBox="0 0 24 24">
                                <path
                                    d="M21.944 4.667a1.5 1.5 0 0 0-1.6-.217L3.6 11.25a1.5 1.5 0 0 0 .1 2.8l3.7 1.3 1.4 4.2a1.5 1.5 0 0 0 2.7.2l2-3.3 3.8 2.8a1.5 1.5 0 0 0 2.4-1l2-12a1.5 1.5 0 0 0-.756-1.583zM9.8 17.1l-1.1-3.3 7.2-6.5-6.1 7.7zm2.7 1.2l-1.1-3.3 2.7 2zm6.2-1.2-3.8-2.8 4.6-7.2z"/>
                            </svg>
                        </div>
                        <input
                            type="text"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <svg width="24" height="24" fill="currentColor"
                                 className="text-primary-dark-pink dark:text-white w-6 h-6" viewBox="0 0 24 24">
                                <path
                                    d="M21.8 8.001a2.75 2.75 0 0 0-1.94-1.94C18.1 6 12 6 12 6s-6.1 0-7.86.06a2.75 2.75 0 0 0-1.94 1.94A28.2 28.2 0 0 0 2 12a28.2 28.2 0 0 0 .2 3.999 2.75 2.75 0 0 0 1.94 1.94C5.9 18 12 18 12 18s6.1 0 7.86-.06a2.75 2.75 0 0 0 1.94-1.94A28.2 28.2 0 0 0 22 12a28.2 28.2 0 0 0-.2-3.999zM10 15.5v-7l6 3.5-6 3.5z"/>
                            </svg>
                        </div>
                        <input
                            type="text"
