...
const MediaPanelImageCard = ({ sort }: { sort: string }) => {
    ...
    const PreviewImageHandler = (
        ...
        fullScreenPreview({ url: media, type, open: true, ref: indexId, otherUrl: medias });
    };
...
interface MediaPanelMediaCardProps {
    media: MediaDataType;
    PreviewImageHandler: (media: string, type: string, isSubscriber: boolean, indexId: number) => void;
    isSubscriber: boolean;
    indexId: number;
}
            ...
            {media.media_type === "video" ? (
                <div className="relative w-full h-full">
                    <video
                        ...
                        onClick={() => PreviewImageHandler(media.url, media.media_type, isSubscriber, indexId)}
                    />
                    <div
                        onClick={() => PreviewImageHandler(media.url, media.media_type, isSubscriber, indexId)}
