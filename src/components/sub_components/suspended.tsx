    ...
    return (
        <>
            <div className="bg-gradient-to-b from-gray-50 to-gray-200 min-h-screen">
                {/* Profile Banner */}
                <div
                    className="h-48 bg-gradient-to-r from-red-200 via-gray-200 to-red-100 flex items-center justify-center relative">
                    <img
                        src="/site/banner.png"
                        alt="Default banner"
                ...
                <div className="bg-white relative pb-6 border-b border-gray-200 shadow-sm">
                    ...
                    <div className="absolute -top-14 left-6">
                        <div
                            className="w-28 h-28 rounded-full border-4 border-red-500 bg-gray-100 flex items-center justify-center overflow-hidden shadow-lg">
                            <svg
                    ...
                    <div className="pt-20 px-6">
                        <div className="flex items-center">
                            ...
                            <span
                                className="ml-3 bg-red-600 text-white text-xs px-3 py-1 rounded-full font-semibold shadow">
              Suspended
            </span>
                        </div>
            ...
            <span className="flex items-center">
              ...
              <span className="font-bold text-gray-800">
                ...
                <div className="flex border-b border-gray-200 bg-white sticky top-0 z-10 shadow-sm">
                    <button
                        className="flex-1 py-3 text-purple-600 font-semibold border-b-2 border-purple-600 flex justify-center items-center transition-colors hover:bg-purple-50">
                        <MessageCircle size={18} className="mr-2"/>
                        Posts
                    </button>
                    <button
                        className="flex-1 py-3 text-gray-500 font-medium flex justify-center items-center transition-colors hover:bg-gray-100">
