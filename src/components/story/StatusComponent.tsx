...
const SelectMoreItems = React.memo(
  ({ openMore, handleOpenMore }: SelectMoreProps) => {
    ...
    return (
      <div className="border-t border-black/30 dark:border-gray-700 max-w-[550px] relative mx-auto bottom-0 left-0 z-20 dark:bg-gray-900 bg-white w-full transition-all duration-300 ease-in-out flex-1">
        <div className="flex flex-col h-[560px] relative dark:bg-gray-900 dark:text-white">
          <div className="flex items-center text-center">
            <button
              onClick={() => setActiveTab("new")}
              className={`flex-1 outline-none cursor-pointer duration-300 transition-all ${
                activeTab === "new"
            ...
            <button
              ...
              className={`flex-1 text-center outline-none cursor-pointer duration-300 transition-all ${
                activeTab === "media"
                  ? "bg-coins-card-bottom dark:text-black"
                  : ""
              }`}
