...
const NavigationBar = () => {
  return (
    <div className="fixed bottom-0 right-0 flex pointer-events-none w-full lg:justify-end">
      <div className="flex py-8 border-t border-black/40 dark:border-slate-800 items-center justify-between px-8 md:px-16 dark:bg-gray-950 dark:text-white bg-white w-full lg:w-[37.5%] pointer-events-auto">
