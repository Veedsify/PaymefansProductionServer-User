...
import { ChangeEvent, type KeyboardEvent, useRef, useState } from "react";
    ...
    >
      ...
      >
        <span className="absolute cursor-pointer top-4 right-4">
          <X className=" text-primary-dark-pink" onClick={closeModal} />
        </span>
        <div className="w-full max-w-xs p-6 py-10">
          ...
          <p className="mb-6 text-center text-gray-500">
            {mode === "verify" ? subtitles.verify : subtitles.create}
          </p>
          ...
          >
            {mode === "verify" ? buttonLabels.verify : buttonLabels.create}
          </button>
