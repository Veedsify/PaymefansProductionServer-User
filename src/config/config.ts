...
const BANK_CONFIG = {
  PLATFORM_FEE_MESSAGE: `25% Fee On Platform Withdrawals`,
};

const SUBSCRIPTIONS_CONFIG = {
  MINIMUM_SUBSCRIPTION_PRICE_NGN: 10000,
  MINIMUM_SUBSCRIPTION_PRICE_USD: 25,
  SUBSCRIPTION_PRICE_ERROR_MSG: `Subscription price must be at least ₦10,000 or $25`,
};
