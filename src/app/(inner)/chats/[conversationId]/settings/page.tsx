    ...
    <div className="flex flex-col items-center min-h-dvh">
      ...
      >
        ...
        <div className="flex items-center p-6 border-b border-gray-200 gap-4 dark:border-gray-800">
          <Link href={`/${conversationReceiver.username}`} className="relative">
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-[200] flex items-center justify-center">
      ...
      >
        ...
        <h3 className="text-base lg:text-xl font-bold text-center text-gray-800 dark:text-gray-100">
          Delete Conversation
        </h3>
        <p className="mt-2 text-sm md:text-base text-center text-gray-600 dark:text-gray-400">
        ...
        <div className="flex justify-center mt-6 gap-3">
          <button
            onClick={onClose}
            className="px-4 py-2 md:text-base text-sm font-medium text-gray-700 rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800"
          >
            Cancel
          </button>
          <button
            onClick={handleDeleteConversation}
            className="px-4 py-2 md:text-base text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700"
          >
            Delete
          </button>
        </div>
