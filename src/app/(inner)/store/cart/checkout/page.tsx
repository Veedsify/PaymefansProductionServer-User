...
const Page = () => {
  const [paymentMethod, setPaymentMethod] = useState<"points" | "paystack">(
    "points",
  );
  return (
    <div className="px-4 py-8 mx-auto max-w-screen-xl sm:px-6 lg:px-8">
      <div className="flex items-center justify-between mb-3">
        <h2 className="text-sm font-bold text-gray-600">Customer Details</h2>
        <Link
          href="/store/cart"
          className="flex items-center text-xs font-semibold text-primary-dark-pink hover:text-primary-text-dark-pink duration-200"
        >
      ...
      <div>
        <form
          action=""
          className="p-2 mb-5 border rounded grid grid-cols-2 gap-3"
        >
          ...
          <div className="col-span-1">
            <select className="w-full p-3 text-xs border-b border-gray-300 outline-none">
              <option value="" selected>
                Select State
              </option>
              <option value="">Nigeria</option>
          ...
          <div className="col-span-2">
            <input
              ...
              className="w-full p-3 text-xs border-gray-300 outline-none"
            />
          </div>
        </form>
      </div>
      <h2 className="mb-3 text-sm font-bold text-gray-600">Payment Method</h2>
      ...
      <div className="col-span-2">
        <button className="w-full p-3 text-xs font-bold text-white rounded bg-primary-dark-pink">
          Pay Now
        </button>
      </div>
    </div>
