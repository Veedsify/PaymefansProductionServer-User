    ...
    return (
        <div className="min-h-[70vh] flex items-center justify-center p-2">
            <div className="text-center lg:w-3/5">
                <Image height={160} width={160} priority src="/images/My project-1 (49) 1.png" alt="" className="object-cover w-40 h-40 mx-auto my-2 rounded-lg" />
                ...
                <div className="mt-8">
                    ...
                    <button className="w-4/5 p-4 font-bold text-white rounded-lg bg-primary-dark-pink ">VERIFY</button>
                </div>
            </div>
        </div>
    );
...
function ModelVerificationSuccess() {
    return (
        <div className="min-h-[70vh] flex items-center justify-center p-2">
            <div className="text-center lg:w-3/5">
                <Image height={64} width={64} src="/images/fi-rr-thumbs-up.png" alt="" className="object-cover w-16 h-16 mx-auto my-2 rounded-lg" />
                ...
                <div className="mt-8">
                    <button className="w-4/5 p-4 font-bold text-white rounded-lg bg-primary-dark-pink ">OK</button>
                </div>
            </div>
        </div>
    );
