...
const VerifyTFA = () => {
    ...
    useEffect(() => {
        // Get email from localStorage (more persistent than sessionStorage)
        const storedEmail = localStorage.getItem("tfaEmail");
    ...
    const submitVerificationForm = async (e: FormEvent) => {
        try {
            ...
            localStorage.removeItem("tfaEmail");
    ...
    const debounceSubmitVerificationForm = debounce(
        ...
        <div className="items-start justify-center mx-auto lg:grid grid-cols-2">
          <div className="relative hidden min-h-dvh lg:block">
            <Image
              ...
              alt="Two-Factor Authentication Image"
          ...
          <div className="h-full lg:p-14 2xl:p-28">
            ...
            <div className="max-w-lg mb-8">
              ...
              <p className="mb-6 text-gray-300 leading-relaxed">
                ...
                below to complete your login. Check your spam folder if not
                received.
              </p>
            </div>
